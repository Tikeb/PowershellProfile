...
if (!$profile.Contains("NuGet_profile")) {
	# Set local variables
	$devLocation = "C:\Code"
	$downloadsLocation = "C:\Users\anthonyward\Downloads"
...
#		}
	...
	function open_repo_explorer {
		if (Test-GitRepo) {
			Git-Repo-Explorer
		} elseif (Test-HgRepo) {
			hg_repo_explorer
		} else {
			FriendlyError "No hg or git repository at this location!"
		}
	}
	set-alias re open_repo_explorer
